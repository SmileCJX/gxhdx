			...
			<div class="am-g">
				<form id="form" class="am-form-inline">
					  <div class="am-form-group">
					      <span >学生姓名</span>
					      <input type="text"  class="am-form-field" id="studentName" name="studentName" placeholder="学生姓名">
					  </div>
					  <div class="am-form-group">
					      <span >学号</span>
					      <input type="text"  class="am-form-field" id="sno" name="sno" placeholder="学号">
					  </div>
					  <div class="am-form-group">
					      <span >年级</span>
					      <input type="text"  class="am-form-field" id="grade" name="grade" placeholder="年级">
					  </div>
					  <div class="am-form-group">
					      <span >学院</span>
					  ...
					  <div class="am-form-group">
					      <span >专业</span>
					      <input type="text"  class="am-form-field" id="profession" name="profession" placeholder="专业">
					  </div>
					  <div class="am-form-group">
					      <span >班级</span>
					      <input type="text"  class="am-form-field" id="classes" name="classes" placeholder="班级">
					  </div>
					  <div class="am-form-group">
					      <span >电话</span>
					      <input type="text"  class="am-form-field" id="phone" name="phone" placeholder="电话">
					  </div>
					  <div class="am-form-group">
					      <span >邮箱</span>
					...
					<div class="am-u-sm-8 ">
					 	 	<button type="button" class="am-btn am-btn-secondary"
									onclick="openWindow('student/add','附件新增');">
