		...
		<div class="admin-content-body">
			<div class="am-cf am-padding am-padding-bottom-0">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">评论管理</strong> / <small>Comment</small>
				</div>
			</div>
			...
			<div class="am-g">
				<form id="form" class="am-form-inline">
					  <div class="am-form-group">
					      <span >评论内容</span>
					      <input type="text"  class="am-form-field" id="content" name="content" placeholder="评论内容">
					  </div>
					  <div class="am-form-group">
					      <span >评论用户</span>
					      <input type="text"  class="am-form-field" id="username" name="username" placeholder="评论用户">
					  </div>
					  <div class="am-form-group">
					      <span >活动ID</span>
					      <input type="text"  class="am-form-field" id="activityId" name="activityId" placeholder="活动ID">
					  </div>
					...
					<div class="am-u-sm-8 ">
					 	 	<button type="button" class="am-btn am-btn-secondary"
									onclick="openWindow('comment/add','附件新增');">
