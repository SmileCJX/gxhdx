			...
			<thead>
				<tr>
					<th class="table-check"><input type="checkbox" id="checkAll" onclick="selectAll();" /></th>
											<th class="table-date am-hide-sm-only">评论内容</th>
						<th class="table-date am-hide-sm-only">评论用户</th>
						<th class="table-date am-hide-sm-only">活动ID</th>
							...
							<div class="am-btn-toolbar">
								<div class="am-btn-group am-btn-group-xs">
									<button type="button" class="am-btn am-btn-default am-text-secondary"
										onclick="openWindow('comment/edit?id=${item.id}','编辑');">
