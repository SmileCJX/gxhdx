		...
		<div class="admin-content-body">
			<div class="am-cf am-padding am-padding-bottom-0">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">新闻管理</strong> / <small>News</small>
				</div>
			</div>
			...
			<div class="am-g">
				<form id="form" class="am-form-inline">
					  <div class="am-form-group">
					      <span >新闻标题</span>
					      <input type="text"  class="am-form-field" id="title" name="title" placeholder="新闻标题">
					  </div>
					  <div class="am-form-group">
					      <span >新闻内容</span>
					      <input type="text"  class="am-form-field" id="content" name="content" placeholder="新闻内容">
					  </div>
					  <div class="am-form-group">
					      <span >发布者</span>
					      <input type="text"  class="am-form-field" id="publisher" name="publisher" placeholder="发布者">
					  </div>
					  <div class="am-form-group">
					      <span >新闻关键字</span>
					...
					<div class="am-u-sm-8 ">
					 	 	<button type="button" class="am-btn am-btn-secondary"
									onclick="openWindow('news/add','附件新增');">
