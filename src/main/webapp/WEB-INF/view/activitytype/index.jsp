		...
		<div class="admin-content-body">
			<div class="am-cf am-padding am-padding-bottom-0">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">活动类型管理</strong> / <small>ActivityType</small>
				</div>
			</div>
			...
			<div class="am-g">
				<form id="form" class="am-form-inline">
					  <div class="am-form-group">
					      <span >活动类型</span>
					      <input type="text"  class="am-form-field" id="typeName" name="typeName" placeholder="活动类型">
					  </div>
					  <div class="am-form-group">
					      <span >简介</span>
					      <input type="text"  class="am-form-field" id="introduction" name="introduction" placeholder="简介">
					  </div>
					...
					<div class="am-u-sm-8 ">
					 	 	<button type="button" class="am-btn am-btn-secondary"
									onclick="openWindow('activitytype/add','附件新增');">
