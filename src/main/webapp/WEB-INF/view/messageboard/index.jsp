		...
		<div class="admin-content-body">
			<div class="am-cf am-padding am-padding-bottom-0">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">留言板管理</strong> / <small>MessageBoard</small>
				</div>
			</div>
			...
			<div class="am-g">
				<form id="form" class="am-form-inline">
					  <div class="am-form-group">
					      <span >联系方式</span>
					      <input type="text"  class="am-form-field" id="phoneNumber" name="phoneNumber" placeholder="联系方式">
					  </div>
					  <div class="am-form-group">
					      <span >标题</span>
					      <input type="text"  class="am-form-field" id="title" name="title" placeholder="标题">
					  </div>
					  <div class="am-form-group">
					      <span >留言内容</span>
					      <input type="text"  class="am-form-field" id="content" name="content" placeholder="留言内容">
					  </div>
					...
					<div class="am-u-sm-8 ">
					 	 	<button type="button" class="am-btn am-btn-secondary"
									onclick="openWindow('messageboard/add','附件新增');">
