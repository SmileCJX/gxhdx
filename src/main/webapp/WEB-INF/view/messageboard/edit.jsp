				...
				<div class="am-u-sm-12 am-u-md-10">
					...
					<input type="hidden" name="id" value="${entity.id }" />
						...
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label"> 联系方式
								/  phoneNumber</label>
							<div class="am-u-sm-9">
								<input type="text" id="phoneNumber" name="phoneNumber" value="${entity.phoneNumber}"
									placeholder="联系方式/ phoneNumber" required="required">
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" id="title" name="title" value="${entity.title}"
									placeholder="标题/ title" required="required">
							</div>
						</div>
					
	
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label"> 留言内容
								/  content</label>
							<div class="am-u-sm-9">
								<input type="text" id="content" name="content" value="${entity.content}"
									placeholder="留言内容/ content" required="required">
							</div>
						</div>
