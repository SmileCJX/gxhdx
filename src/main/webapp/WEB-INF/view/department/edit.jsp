					...
					<input type="hidden" name="id" value="${entity.id }" />
						...
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label"> 部门编号
								/  dno</label>
							<div class="am-u-sm-9">
								<input type="text" id="dno" name="dno" value="${entity.dno}"
						...
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label"> 部长姓名
								/  ministerName</label>
							<div class="am-u-sm-9">
								<input type="text" id="ministerName" name="ministerName" value="${entity.ministerName}"
						...
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label"> 部长电话
								/  ministerPhone</label>
							<div class="am-u-sm-9">
								<input type="text" id="ministerPhone" name="ministerPhone" value="${entity.ministerPhone}"
						...
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label"> 总人数
								/  totalPersons</label>
							<div class="am-u-sm-9">
								<input type="text" id="totalPersons" name="totalPersons" value="${entity.totalPersons}"
