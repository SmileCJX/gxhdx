		...
		<div class="admin-content-body">
			<div class="am-cf am-padding am-padding-bottom-0">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">报名管理</strong> / <small>Signs</small>
				</div>
			</div>
			...
			<div class="am-g">
				<form id="form" class="am-form-inline">
					  ...
					  <div class="am-form-group">
					      <span >报名用户</span>
					      <input type="text"  class="am-form-field" id="applyName" name="applyName" placeholder="报名用户">
					  </div>
					  <div class="am-form-group">
					      <span >审核</span>
					      <input type="text"  class="am-form-field" id="available" name="available" placeholder="审核">
					  </div>
					...
					<div class="am-u-sm-8 ">
					 	 	<button type="button" class="am-btn am-btn-secondary"
									onclick="openWindow('signs/add','附件新增');">
