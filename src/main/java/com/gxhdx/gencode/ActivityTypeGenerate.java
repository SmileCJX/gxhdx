...
public class ActivityTypeGenerate {

	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static void main(String[] args) {
		Map data = new HashMap();
		data.put("className", "ActivityType"); // 类名
		data.put("classCnName", "活动类型管理"); // 中文名
		List pros = new ArrayList();
		pros.add(new GenProperty("typeName", "活动类型", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("introduction", "简介", String.class.getSimpleName(),
				"like",true));
	...
	public static void createF(Map data) {
		...
		/* 生成edit */
		dir = System.getProperty("user.dir")
				+ "/src/main/webapp/WEB-INF/view/activitytype/";// 生成路径
