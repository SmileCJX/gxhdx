...
public class CommentGenerate {
	...
	public static void main(String[] args) {
		...
		data.put("className", "Comment"); // 类名
		data.put("classCnName", "评论管理"); // 中文名
		List pros = new ArrayList();
		pros.add(new GenProperty("content", "评论内容", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("username", "评论用户", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("activityId", "活动ID", Integer.class.getSimpleName(),
				"eq",false));
	...
	public static void createF(Map data) {
		...
		/* 生成edit */
		dir = System.getProperty("user.dir")
				+ "/src/main/webapp/WEB-INF/view/comment/";// 生成路径
