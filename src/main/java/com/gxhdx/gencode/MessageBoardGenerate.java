...
public class MessageBoardGenerate {

	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static void main(String[] args) {
		Map data = new HashMap();
		data.put("className", "MessageBoard"); // 类名
		data.put("classCnName", "留言板管理"); // 中文名
		List pros = new ArrayList();
		pros.add(new GenProperty("phoneNumber", "联系方式", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("title", "标题", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("content", "留言内容", String.class.getSimpleName(),
				"like",true));
	...
	public static void createF(Map data) {
		...
		/* 生成edit */
		dir = System.getProperty("user.dir")
				+ "/src/main/webapp/WEB-INF/view/messageboard/";// 生成路径
