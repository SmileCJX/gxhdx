...
public class SignsGenerate {

	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static void main(String[] args) {
		Map data = new HashMap();
		data.put("className", "Signs"); // 类名
		data.put("classCnName", "报名管理"); // 中文名
		List pros = new ArrayList();
		pros.add(new GenProperty("title", "活动标题", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("applyName", "报名用户", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("available", "审核", Boolean.class.getSimpleName(),
				"eq",true));
	...
	public static void createF(Map data) {
		...
		/* 生成edit */
		dir = System.getProperty("user.dir")
				+ "/src/main/webapp/WEB-INF/view/signs/";// 生成路径
