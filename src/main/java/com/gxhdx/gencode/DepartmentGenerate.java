...
public class DepartmentGenerate {
	...
	public static void main(String[] args) {
		...
		data.put("className", "Department"); // 类名
		data.put("classCnName", "部门管理"); // 中文名
		List pros = new ArrayList();
		pros.add(new GenProperty("dno", "部门编号", String.class.getSimpleName(),
				"eq",true));
		pros.add(new GenProperty("name", "部门名称", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("ministerName", "部长姓名", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("ministerPhone", "部长电话", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("totalPersons", "总人数", Integer.class.getSimpleName(),
				"eq",false));
		pros.add(new GenProperty("description", "描述", String.class.getSimpleName(),
				"like",false));
	...
	public static void createF(Map data) {
		...
		/* 生成edit */
		dir = System.getProperty("user.dir")
				+ "/src/main/webapp/WEB-INF/view/department/";// 生成路径
