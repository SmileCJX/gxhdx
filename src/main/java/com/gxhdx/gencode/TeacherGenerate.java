...
public class TeacherGenerate {
	...
	public static void main(String[] args) {
		...
		data.put("className", "Teacher"); // 类名
		data.put("classCnName", "教师管理"); // 中文名
		List pros = new ArrayList();
		pros.add(new GenProperty("teacherName", "教师姓名", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("tno", "教师编号", String.class.getSimpleName(),
				"eq",true));
		pros.add(new GenProperty("academy", "学院", String.class.getSimpleName(),
				"eq",true));
		pros.add(new GenProperty("rank", "职称", String.class.getSimpleName(),
				"eq",true));
		pros.add(new GenProperty("research", "研究方向", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("honer", "荣誉", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("education", "学历", String.class.getSimpleName(),
				"eq",true));
		pros.add(new GenProperty("email", "邮箱", String.class.getSimpleName(),
				"eq",false));
		pros.add(new GenProperty("role", "角色", String.class.getSimpleName(),
				"eq",false));
		pros.add(new GenProperty("introduction", "介绍", String.class.getSimpleName(),
				"like",true));
	...
	public static void createF(Map data) {
		...
		/* 生成edit */
		dir = System.getProperty("user.dir")
				+ "/src/main/webapp/WEB-INF/view/teacher/";// 生成路径
