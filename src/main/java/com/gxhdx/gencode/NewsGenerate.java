...
public class NewsGenerate {
	...
	public static void main(String[] args) {
		...
		data.put("className", "News"); // 类名
		data.put("classCnName", "新闻管理"); // 中文名
		List pros = new ArrayList();
		pros.add(new GenProperty("title", "新闻标题", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("content", "新闻内容", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("publisher", "发布者", String.class.getSimpleName(),
				"eq",true));
		pros.add(new GenProperty("keyword", "新闻关键字", String.class.getSimpleName(),
				"like",true));
		pros.add(new GenProperty("url", "新闻相关连接", String.class.getSimpleName(),
				"like",false));
		pros.add(new GenProperty("picurl", "新闻图片", String.class.getSimpleName(),
				"like",false));
	...
	public static void createF(Map data) {
		...
		/* 生成edit */
		dir = System.getProperty("user.dir")
				+ "/src/main/webapp/WEB-INF/view/news/";// 生成路径
