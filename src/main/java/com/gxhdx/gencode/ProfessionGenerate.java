...
public class ProfessionGenerate {

	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static void main(String[] args) {
		Map data = new HashMap();
		data.put("className", "Profession"); // 类名
		data.put("classCnName", "专业管理"); // 中文名
		List pros = new ArrayList();
		pros.add(new GenProperty("professionName", "专业名称", String.class.getSimpleName(),
				"like",true));
	...
	public static void createF(Map data) {
		...
		/* 生成edit */
		dir = System.getProperty("user.dir")
				+ "/src/main/webapp/WEB-INF/view/profession/";// 生成路径
